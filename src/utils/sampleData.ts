import { Student, Payment, Invoice, AttendanceRecord } from '../types';
...
export const sampleStaffAttendanceRecords = [
  { id: '1', staffId: '1', date: '2024-05-01', status: 'present' },
...
export const sampleSystemSettings = {
  ...
  logoUrl: '',
  contactEmail: 'info@excellenceacademy.com',
